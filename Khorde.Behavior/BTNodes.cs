...
namespace Khorde.Behavior
{
	...
	public struct UtilityActionBlock
	{
		public BTExecNodeId nodeId;
	...
	public struct UtilitySelector
	{
		public enum TieBreakMode : byte
		{
			Top,
			Random,
		}

		public half tieTolerance;
		public TieBreakMode tieBreakMode;
		public BlobArray<UtilityActionBlock> actions;

		// downstream query nodes required for utility computation
		public BlobArray<BTExecNodeId> queries;
	...
	public struct UtilityCooldown
	{
		public BTExecNodeId child;
		public float invDuration;
		public bool softCooldown;
		public BlobCurve curve;
		public VariableId lastExecutionTime; // autogenerated blackboard variable

		public string DumpString()
		{
			return $"{{ child={child} invDuration={invDuration} }}";
		}
	}
	...
	public struct Utility
	{
		...
		public string DumpString()
		{
			return $"{{ child={child} input={input} }}";
		}
	}

	public partial struct CurrentUtility : IExpression
	{
		...
		{
			untypedResult.ReinterpretStore(0, ctx.utility);
		}
	}

	/// <summary>
	/// Placeholder type to show live utility values in port previews
	/// </summary>
	[Serializable]
