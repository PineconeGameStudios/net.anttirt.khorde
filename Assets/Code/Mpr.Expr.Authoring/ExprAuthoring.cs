...
namespace Mpr.Expr.Authoring
{
    ...
    public static class ExprAuthoring
    {
        ...
        public static Dictionary<BlobAssetBase, List<LayoutVariable>>
            ComputeLayout(List<(BlobAssetBase, Ptr<BlobExpressionData>)> expressions)
        {
            ...
            var assetLayouts = new Dictionary<BlobAssetBase, List<LayoutVariable>>();
        ...
        public static BlobAssetReference<ExpressionBlackboardLayouts.LayoutContainer> BakeLayout(
            Dictionary<BlobAssetBase, List<LayoutVariable>> layouts, Allocator allocator)
        {
            ...
            {
                blobLayouts[index].asset = asset.DataHash;
