...
public partial struct Swizzle32x1 : IExpression<int>
{
    ...
    public unsafe void Evaluate(in ExpressionEvalContext ctx, in int input0, int outputIndex, ref NativeSlice<byte> untypedResult)
    {
...
public partial struct Swizzle32x2 : IExpression<int2>
{
    ...
    public unsafe void Evaluate(in ExpressionEvalContext ctx, in int2 input0, int outputIndex, ref NativeSlice<byte> untypedResult)
    {
        var result = untypedResult.SliceConvert<int>();
...
public partial struct Swizzle32x3 : IExpression<int3>
{
    ...
    public unsafe void Evaluate(in ExpressionEvalContext ctx, in int3 input0, int outputIndex, ref NativeSlice<byte> untypedResult)
    {
        var result = untypedResult.SliceConvert<int>();
        fixed (int* inputData = &input0.x)
            for (int i = 0; i < @operator.outputCount; ++i)
...
public partial struct Swizzle32x4 : IExpression<int4>
{
    ...
    public unsafe void Evaluate(in ExpressionEvalContext ctx, in int4 input0, int outputIndex, ref NativeSlice<byte> untypedResult)
    {
        var result = untypedResult.SliceConvert<int>();
        fixed (int* inputData = &input0.x)
            for (int i = 0; i < @operator.outputCount; ++i)
