	...
	public class BehaviorTreeGraphTests
	{
		...
		public void Test_MoveAround()
		{
			...
			try
			{
				...
				BehaviorTreeExecution.Execute(data, ref state, threads, stack, default, default, blackboard.AsNativeArray(), ref ExpressionBlackboardLayout.Empty, default, default, ref defaultPendingQuery, comps, lookups, 0, 0, trace);
		...
		public void Test_Parallel_Wait()
		{
			...
			AssertTrace(
				...
				Trace(1, BTExecType.Sequence,   5,     2, Event.Call),
				Trace(1, BTExecType.If,         7,       3, Event.Call),
				Trace(1, BTExecType.Nop,        0,         4, Event.Return),
				Trace(1, BTExecType.If,         7,       3, Event.Return),
				Trace(1, BTExecType.Sequence,   5,     2, Event.Call),
