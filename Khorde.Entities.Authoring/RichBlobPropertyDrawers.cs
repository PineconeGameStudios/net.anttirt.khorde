...
{
	abstract class BlobWeakReferencePropertyDrawerBase : PropertyDrawer
	{
		...
		{
			if(t == typeof(BlobObjectSceneReference))
				return typeof(SceneAsset);
			if(t == typeof(BlobEntityPrefabReference))
				return typeof(GameObject);
			if(t == typeof(BlobEntitySceneReference))
				return typeof(SceneAsset);
			if(t.IsGenericType)
	...
	[CustomPropertyDrawer(typeof(BlobWeakObjectReference<>), true)]
	class WeakObjectReferencePropertyDrawer : BlobWeakReferencePropertyDrawerBase
	{
		public override WeakReferenceGenerationType GenerationType => WeakReferenceGenerationType.UnityObject;
	}

	[CustomPropertyDrawer(typeof(BlobObjectSceneReference), true)]
	class WeakObjectSceneReferencePropertyDrawer : BlobWeakReferencePropertyDrawerBase
	{
		public override WeakReferenceGenerationType GenerationType => WeakReferenceGenerationType.GameObjectScene;
	}

	[CustomPropertyDrawer(typeof(BlobEntitySceneReference), true)]
	class EntitySceneReferencePropertyDrawer : BlobWeakReferencePropertyDrawerBase
	{
		public override WeakReferenceGenerationType GenerationType => WeakReferenceGenerationType.EntityScene;
	}

	[CustomPropertyDrawer(typeof(BlobEntityPrefabReference), true)]
	class EntityPrefabReferencePropertyDrawer : BlobWeakReferencePropertyDrawerBase
	{
