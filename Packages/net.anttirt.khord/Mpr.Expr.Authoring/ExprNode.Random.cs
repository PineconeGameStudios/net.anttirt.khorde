...
namespace Mpr.Expr.Authoring
{
	...
	class RandomInt : ExprBase
	{
		...
		{
			var expr = new Mpr.Expr.RandomInt { };
	...
	class RandomFloat2Direction : ExprBase
	{
		...
		public override void Bake(GraphExpressionBakingContext context, ExpressionStorageRef storage)
		{
			context.CreateExpression(storage, new Mpr.Expr.RandomFloat2Direction());
		}
	...
	class RandomFloat3Direction : ExprBase
	{
		...
		public override void Bake(GraphExpressionBakingContext context, ExpressionStorageRef storage)
		{
			context.CreateExpression(storage, new Mpr.Expr.RandomFloat3Direction());
		}
