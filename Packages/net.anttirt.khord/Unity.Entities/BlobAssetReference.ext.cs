...
namespace Unity.Entities
{
	public static class BlobAssetReferenceExt
	{
		...
		/// <summary>
		/// Get the hash of the blob asset. This is the same hash as returned by IBaker.AddBlobAsset.
		/// </summary>
		/// <typeparam name="T"></typeparam>
		/// <param name="asset"></param>
		/// <returns></returns>
		public static unsafe Hash128 GetHash<T>(this BlobAssetReference<T> asset) where T : unmanaged
		{
			asset.m_data.ValidateNotNull();
			Hash128 hash = default;
			UnsafeUtility.MemCpy(&hash, &asset.m_data.Header->Hash, sizeof(ulong));
			return hash;
		}
	}
}