...
namespace Khorde.Expr
{
	...
	[BurstCompile]
	public partial struct DistanceFloat2
	{
		[BurstCompile]
		public static unsafe void EvaluateFunc(ExpressionStorage* self, in ExpressionEvalContext ctx, int outputIndex,
			ref NativeArray<byte> untypedResult)
		{
			EvalHelper.Evaluate<DistanceFloat2, float2, float2>(self, in ctx, outputIndex, ref untypedResult);
		}
	}

	[BurstCompile]
	public partial struct DistanceFloat3
	{
		[BurstCompile]
		public static unsafe void EvaluateFunc(ExpressionStorage* self, in ExpressionEvalContext ctx, int outputIndex,
			ref NativeArray<byte> untypedResult)
		{
			EvalHelper.Evaluate<DistanceFloat3, float3, float3>(self, in ctx, outputIndex, ref untypedResult);
		}
	}

	[BurstCompile]
	public partial struct DistanceFloat4
	{
		[BurstCompile]
		public static unsafe void EvaluateFunc(ExpressionStorage* self, in ExpressionEvalContext ctx, int outputIndex,
			ref NativeArray<byte> untypedResult)
		{
			EvalHelper.Evaluate<DistanceFloat4, float4, float4>(self, in ctx, outputIndex, ref untypedResult);
		}
	}
