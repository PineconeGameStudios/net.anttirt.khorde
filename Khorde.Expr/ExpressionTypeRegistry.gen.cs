...
namespace Khorde.Expr.Generated
{
	...
	static unsafe class ExpressionTypeRegistry
	{
		public static readonly ExpressionTypeInfo[] ExpressionTypes = new[]
		{
			...
			new ExpressionTypeInfo(typeof(Normalize2), Normalize2.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Normalize3), Normalize3.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Normalize4), Normalize4.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Floor1), Floor1.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Floor2), Floor2.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Floor3), Floor3.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Floor4), Floor4.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Ceiling1), Ceiling1.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Ceiling2), Ceiling2.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Ceiling3), Ceiling3.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Ceiling4), Ceiling4.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(ToFloat1), ToFloat1.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(ToFloat2), ToFloat2.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(ToFloat3), ToFloat3.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(ToFloat4), ToFloat4.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Rescale2), Rescale2.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Rescale3), Rescale3.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Rescale4), Rescale4.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(AngleToDirection), AngleToDirection.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Rotate2D), Rotate2D.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(Rotate3D), Rotate3D.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(AxisAngle), AxisAngle.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(GetTranslation), GetTranslation.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(GetRotation), GetRotation.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(GetScale), GetScale.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(WithTranslation), WithTranslation.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(WithRotation), WithRotation.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(WithScale), WithScale.EvaluateFunc, true),
