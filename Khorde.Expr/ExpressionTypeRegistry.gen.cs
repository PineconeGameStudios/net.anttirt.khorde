...
namespace Khorde.Expr.Generated
{
	...
	static unsafe class ExpressionTypeRegistry
	{
		public static readonly ExpressionTypeInfo[] ExpressionTypes = new[]
		{
			...
			new ExpressionTypeInfo(typeof(DistanceFloat2), DistanceFloat2.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(DistanceFloat3), DistanceFloat3.EvaluateFunc, true),
			new ExpressionTypeInfo(typeof(DistanceFloat4), DistanceFloat4.EvaluateFunc, true),
